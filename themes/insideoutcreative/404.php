...
echo '<section class="pb-5 position-relative bg-attachment" style="background:url('. $globalImg['url'] . ');background-size:cover;background-attachment:fixed;padding-top:175px;">';
